...
<script>
	...
	$(document).ready(function() {
		$('button').click(function() {
			let promise = fetch("hello.jsp") // Promise 객체
			promise.then(function(response) { // 응답 완료가 됬을 때  콜백 함수 호출
			...
			/*
		fetch("hello.jsp") // Promise 객체
		.then(function(response) { // 응답 완료가 됬을 때  콜백 함수 호출
				console.log(response)
				return response.text()
			}).then(function(data) {
				//console.log(data)
